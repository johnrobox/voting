...
<div class="modal fade" id="deleteMessage<?php echo $rowMessageModal->message_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash-o"></i> Delete Message </h4>
      </div>
      <?php echo form_open(base_url().'delete_admin_message'); ?>
